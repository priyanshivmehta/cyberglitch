...
function calculateWeightOnMercury() {
    ...
    const mercuryGravity = 0.89; // Mercury's gravity relative to Earth's
    const weightOnMercury = weightOnEarth * mercuryGravity;
    document.getElementById('result').innerText = `Your weight on Uranus would be ${weightOnMercury.toFixed(2)} kg`;
}